...
wxBoxSizer *CatheterFrame::CreateChannelRowSizer(int ids[]) {
    ...
    chanSizerH->Add(new wxCheckBox(controlPanel, ids[0], wxString("include")));
    chanSizerH->AddSpacer(5);
    ...
    chanSizerH->AddSpacer(5);
    chanSizerH->Add(new wxCheckBox(controlPanel, ids[3], wxString("poll")));
    chanSizerH->AddSpacer(5);
    chanSizerH->Add(new wxCheckBox(controlPanel, ids[4], wxString("ena")));
    chanSizerH->AddSpacer(5);
    chanSizerH->Add(new wxCheckBox(controlPanel, ids[5], wxString("upd")));
    chanSizerH->AddSpacer(5);
    chanSizerH->Add(new wxCheckBox(controlPanel, ids[6], wxString("dir")));
