...
//#define PLAYPATH "/home/acceber/common/workspaces/matlab/cwru/research/cavusoglu/catheter/matlabPacketGen_v4.1/play/catheter.play"
#define PLAYPATH "C:/Users/acceber/Documents/MATLAB/cwru/research/cavusoglu/catheter/matlabPacketGen_v4.1/play/catheter.play"


using namespace std;

/* for matlab-- populate a vector of packet bytes and a vector of inter-packet wait-times */
void mexPacketBytesFromPlayfile(std::vector<std::vector<uint8_t>>& packetVect, std::vector<int>& waits) {
    packetVect.clear();
    waits.clear();    
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  mexPacketBytesFromPlayfile(packetVect, waits);
