...
function catheter_guix2
    ...
    clearAll = uicontrol('Parent', packetPanel, 'Style', 'pushbutton', 'String', 'Clear All',...
        'Units', 'normalized', 'Position', [3*bPadX+2*bNormX, 0, bNormX, 1/(NCHANNELS+1)/2], 'Callback', {@onClearAll});
